...
export async function runStorageProofVerifier(
  ...
  if (options.signal?.aborted) {
    throw new StorageVerifierError("A3_STORAGE_VERIFIER_ABORTED");
  }
  ...
  return new Promise((resolve, reject) => {
    ...
    const timer = setTimeout(() => terminate("A3_STORAGE_VERIFIER_TIMEOUT"), timeoutMs);
    ...
    child.once("error", () => finish(new StorageVerifierError("A3_STORAGE_VERIFIER_SPAWN_FAILED")));
