  ...
  const rawDimensions: ProofDimension[] = [
    ...
    },
    {
      ...
      details: invocations.flatMap((invocation) => [
        ...
        ...(invocation.sourceMetadata ? [
          `Subgraph ID: ${invocation.sourceMetadata.subgraphId}`,
          `Deployment ID: ${invocation.sourceMetadata.deploymentId}`,
          `Network: ${invocation.sourceMetadata.network}`,
          `Block number: ${invocation.sourceMetadata.blockNumber}`,
          `Block hash: ${invocation.sourceMetadata.blockHash}`,
          `Source completed at: ${invocation.sourceMetadata.completedAt}`,
        ] : []),
