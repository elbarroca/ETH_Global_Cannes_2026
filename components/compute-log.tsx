...
const ACTION_LABELS: Record<string, { icon: string; label: string; tint: string }> = {
  ...
  DEBATE_ALPHA: { icon: "🟢", label: "Alpha inference", tint: "text-green-400" },
  DEBATE_RISK: { icon: "🔴", label: "Risk challenge", tint: "text-blood-300" },
  DEBATE_EXECUTOR: { icon: "🟡", label: "Executor decision", tint: "text-gold-400" },
  ...
  PAYMENT_SENT: { icon: "📋", label: "Payment sent", tint: "text-blue-400" },
  SWAP_EXECUTED: { icon: "⚡", label: "Swap executed (Arc)", tint: "text-cyan-400" },
  SWAP_FAILED: { icon: "⚠️", label: "Swap failed", tint: "text-blood-400" },
