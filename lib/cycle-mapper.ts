...
export function mapCycleResultToCycle(result: CycleResult): Cycle {
  ...
  return {
    ...
    trade: {
      ...
      assetSubstituted: (execParsed as { asset_substituted?: boolean }).asset_substituted === true,
      originalAsset: (execParsed as { original_asset?: string }).original_asset,
    },
    memory: [],
...
export function mapEnrichedResponseToCycle(r: EnrichedCycleResponse): Cycle {
  return {
    ...
    trade: {
      ...
      assetSubstituted: r.decision.assetSubstituted,
      originalAsset: r.decision.originalAsset,
    },
    memory: [],
