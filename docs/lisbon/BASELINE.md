...
| Field | Value |
|---|---|
| Repository | `https://github.com/elbarroca/ETH_Global_Cannes_2026.git` |
| Cannes showcase | `https://ethglobal.com/showcase/alpha-dawg-fh6vm` |
| Baseline commit | `bfa7bd37c573e2e49525d965f7f937210e170d72` |
| Baseline tree | `f39cc7e865d8e3ffaa02ea3e2397cee1bbed8c0a` |
| `package.json` SHA-256 | `7c946dbe078b8260497298904a9950479359cbe2b3a263ea4f3d86a881f3719e` |
| `package-lock.json` SHA-256 | `b4a1aed30a52a74d1b4396da9f1d6535a5e475da1b40a99a6c744aae1a8c6b33` |
| Lisbon branch | `developer` |
| Lisbon worktree | `/Users/barroca888/Downloads/Dev/Personal/ETH_Global_Cannes_2026-lisbon` |

The Cannes implementation, deployments, contracts, accounts, screenshots, and receipts are inherited prior work. They are not Lisbon evidence.

## Lisbon boundary

New Lisbon work begins with this control packet. The protected new slice is:

1. deterministic foundation;
2. authenticated immutable agent hiring kernel;
