...
| Deterministic local engineering foundation | `PASS_LOCAL_ONLY; REMEDIATION_G1_PENDING_AUDIT` | A1 cold gate plus exact synthetic sentinel hash replay in [`evidence/A1-DETERMINISTIC-FOUNDATION.md`](evidence/A1-DETERMINISTIC-FOUNDATION.md). Live Cannes migration compatibility, dependency audit remediation, release, sponsor connectivity, and production readiness remain unproven. |
