...
3. `A5_ACCEPTED`: reconcile the existing local A5 remediation audit, then prove one protected creator -> publish -> external hire -> receipt journey with no legacy marketplace authority.
